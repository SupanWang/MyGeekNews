...
public class SelectionAdapter extends RecyclerView.Adapter<SelectionAdapter.ViewHolder> {
    private ArrayList<SelectionBean.NewslistBean> list = new ArrayList<>();
    ...
    public void update(List<SelectionBean.NewslistBean> list) {
        this.list.clear();
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int position) {
        SelectionBean.NewslistBean newslistBean = list.get(position);
